...
class ConnectivityPlusPage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        centerTitle: true,
        title: const Text("Check Your Device Connection",style: TextStyle(fontWeight: FontWeight.bold),),
              ...
              children: [
                Center(
                  child: Padding(
                    ...
                    child: Image.network("https://cdn.dribbble.com/users/795597/screenshots/11391032/media/544afc504427fb3e74abd14a6955fc98.gif"),
                  ),
                ),
                const Align(
                  alignment: Alignment(0,-0.5),
                  child: Text("Your Network Is Perfect Work",style: TextStyle(fontWeight: FontWeight.bold),),
                ),
              ],
            );
          } else {
